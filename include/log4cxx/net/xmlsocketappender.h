/***************************************************************************
                          xmlsocketappender.h  -  class XMLSocketAppender
                             -------------------
...
namespace log4cxx
{
	...
	namespace net
	{
		...
		typedef helpers::ObjectPtr<XMLSocketAppender> XMLSocketAppenderPtr;
        ...
        */
		...
		public:
    		...
    		*/
    		XMLSocketAppender(const tstring& host, int port);
