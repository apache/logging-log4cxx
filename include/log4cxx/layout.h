	...
	public:
		...
		*/
		virtual void format(LogString& output,
                    const spi::LoggingEventPtr& event, apr_pool_t* pool) const = 0;
		...
		*/
		...
		nothing.
		*/
		virtual void appendHeader(LogString& output, apr_pool_t* p) {}

		/**
		Append the footer for the layout format. The base class does
		nothing.
		*/
		virtual void appendFooter(LogString& output, apr_pool_t* p) {}
