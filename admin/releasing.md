...
1. Unpack the release files using these commands (with `apache-dist-logging-dev/log4cxx/1.8.1` as the working directory)
    - `unzip "$HOME/Downloads/release_files.zip"`
1. Send the 8 new artifacts to svn (with `apache-dist-logging-dev/log4cxx/1.8.1` as the working directory)
    - `svn add *`
